...
#define CONFIG_USE_HZK64        1//使用汉字库
#define CONFIG_USE_HZK16        1//使用汉字库
...
#define CONFIG_HZK64_PATH       /*"F:\\My_Program\\c_program\\led_scroll\\*/"HZK64"
...
extern void   gdi_hzk16_putc(int32 x, int32 y, const int8 *hz, int32 bgCol, int32 fgCol);
extern void   gdi_hzk16_puts(int32 x, int32 y, const int8 *str, int32 bgCol, int32 fgCol);
#endif
